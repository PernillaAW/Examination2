...
class Gameplay:
    ...
    def winner(self, user_to_save):
        ...
        print(f"{user_to_save.get_user_name()} has won the game! Congratulations."
              f" You have scored {user_to_save.score} points this round and tossed "
              f"{user_to_save.toss_count} times.")
